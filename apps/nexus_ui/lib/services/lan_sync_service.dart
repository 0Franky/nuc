...
/// Per-device color palette for notification cards
class NexusDeviceColors {
  ...
  static Color colorForDeviceName(String deviceName) {
    ...
    if (normalizedId.contains('pc') || normalizedId.contains('windows') || normalizedId.contains('desktop') || normalizedId.contains('laptop') || normalizedId.contains('mac') || normalizedId.contains('linux')) {
      return _palette[0]; // Indigo for primary PC / Desktop
    }
    if (normalizedId.contains('android') || normalizedId.contains('smartphone') || normalizedId.contains('phone') || normalizedId.contains('iphone')) {
